@section('navbar')
    <nav id="master-navbar" class="navbar navbar-expand-lg navbar-light bg-light mb-4 sticky-top">
        ...
        <div class="collapse navbar-collapse" id="navbarColor03">
            <ul class="navbar-nav mr-auto">
                @if (str_contains(Route::currentRouteName(), 'calendar'))
                ...
                || str_contains(Route::currentRouteName(), 'category') || str_contains(Route::currentRouteName(), 'utilisateur'))
                    <li class="nav-item active">
                        <a class="nav-link" href="{{ route('reservations.index') }}">Administration</a>
                    </li>
                @else
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('reservations.index') }}">Administration</a>
                    ...
                    @auth
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a href="{{ route('record') }}" class="dropdown-item">Mes anciennes réservations</a>
