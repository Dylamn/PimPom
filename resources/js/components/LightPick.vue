...
<style>
    ...
    .lightpick__day:not(.is-before):hover {
        background-size: contain;
        background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'%3E%3Ccircle fill='%23E0E0E0' cx='16' cy='16' r='16'/%3E%3C/svg%3E");
    }

    .lightpick__day.is-before {
        opacity: 0.38;
        pointer-events: none;
    }

    .lightpick__day.is-before.is-forward-selected {
        opacity: 1;
    }

    .lightpick__day.is-before.is-forward-selected:not(.is-start-date) {
        background-color: rgba(38, 139, 210, 0.1);
        background-image: none;
    }

    .lightpick__day.lightpick__day.is-in-range:not(.is-before) {
        opacity: 1;
    }
